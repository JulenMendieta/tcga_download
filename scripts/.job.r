...
.NAME = "tcga_download" #job name. NO SPACES
...
.job$dir$data <- file.path ("~", "datos",    "2015", .job$name) #starting with ("~") if working in your home directory
.job$dir$code <- file.path ("~", "trabajos", "2015", .job$name) #or ("") if working in the root directory !!!
